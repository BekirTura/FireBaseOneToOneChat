...
public class ProgressBarCircularIndetermininate extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setMinimumHeight(Utils.dpToPx(getResources().getDimension(R.dimen.tab_height_new), getResources()));
        setMinimumWidth(Utils.dpToPx(getResources().getDimension(R.dimen.tab_height_new), getResources()));
