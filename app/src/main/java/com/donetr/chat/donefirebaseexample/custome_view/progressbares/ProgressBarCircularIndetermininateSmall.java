...
public class ProgressBarCircularIndetermininateSmall extends CustomView {
    ...
    public ProgressBarCircularIndetermininateSmall(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setMinimumHeight(Utils.dpToPx(15, getResources()));
        setMinimumWidth(Utils.dpToPx(15, getResources()));
    ...
    private void drawFirstAnimation(Canvas canvas) {
        if (radius1 < getWidth() / 2) {
            ...
            if (cont >= 50) {
                ...
                radius2 = (radius2 >= getWidth() / 2 - Utils.dpToPx(2, getResources())) ? (float) getWidth() / 2 - Utils.dpToPx(2, getResources()) : radius2 + 1;
            }
